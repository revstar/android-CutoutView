...
public class CutoutView extends View {
    ...
    private void init(Context context) {
        ...
        mActionPaint.setColor(Color.BLUE);
        mActionPaint.setStrokeWidth(10.0f);
        mActionPaint.setPathEffect(new DashPathEffect(new float[]{15.0f,30.f,15.0f,30.f},15.0f));
        ...
        mEnlargePaint.setPathEffect(new DashPathEffect(new float[]{50.f,30.f,50.f,30.f},15.0f));
        mEnlargePaint.setColor(Color.WHITE);
        mEnlargePaint.setStrokeWidth(10.0f);
